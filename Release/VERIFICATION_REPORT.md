# PinChat 3.11 任务卡悬停表面版验证报告

验证日期：2026-09-18（Asia/Shanghai）

## 交付物

- `PinChat.app`：macOS 14+、Apple Silicon、本机 ad-hoc 签名的可运行应用，版本 0.3.11（19）。
- `PinChat-source.zip`：完整 Swift Package / Xcode 工程源码，不含 Git、构建缓存和应用产物。
- v1.0、v1.1、v2.0、v2.1、v2.2、v2.3、v2.4、v2.5、v3.0、v3.1、v3.2、v3.3、v3.4、v3.5、v3.6、v3.7、v3.8、v3.9、v3.10、v3.11 二十份只读冻结需求及各自 SHA-256 校验文件。
